...
export class QuotaMonitorDashboard extends Stack {
  constructor(scope: App, id: string, props?: StackProps) {
    ...
    const fnUrl = api.addFunctionUrl({ authType: lambda.FunctionUrlAuthType.AWS_IAM, cors: { allowedOrigins: [allowedOrigin.valueAsString], allowedMethods: [lambda.HttpMethod.GET], allowedHeaders: ["authorization", "content-type"] } });
